...
#define k_DURATION_dismissVC 0.3
...
{
    [[NSNotificationCenter defaultCenter] postNotificationName:@"NOTIFICATIONHIDDETELL" object:nil userInfo:[NSDictionary dictionaryWithObject:@"1" forKey:@"hidde"]];
...
- (void)dismissViewControllerOverCurrentContextAnimated:(BOOL)animated completion:(void (^)(void))completion
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"NOTIFICATIONHIDDETELL" object:nil userInfo:[NSDictionary dictionaryWithObject:@"0" forKey:@"hidde"]];
